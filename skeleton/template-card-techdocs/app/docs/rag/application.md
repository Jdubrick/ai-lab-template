...
The user of the application will be able to upload documents via the UI and the LLM will use reference information within those documents to provide more accurate responses to the prompt.
